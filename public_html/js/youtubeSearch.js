...
function getResponse(response) {
    ...
    tabbedVideo = $("<div class='youtube' id='" +  JSON.parse(Videos).items[index].id.videoId  + "' style='width: 100%; height: 225px; '></div>");
    $("#mashup-videos-panel").append(video);
    $("#mashup-videos-panel-tab-youtube").append(tabbedVideo);
    }
    }
    findAndCreate();
}
